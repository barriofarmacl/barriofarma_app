...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header */}
      <header className="border-b bg-purple-800">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={category.title} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                  ...
                  />
                  <h3 className="text-lg font-semibold text-purple-800 text-center">{category.title}</h3>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">Lunes a Domingo: 8:00 - 21:00</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
