...
class TestEpic8Story82RoleAuthorization(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if hasattr(self, 'test_prescriptions'):
            for presc_name in self.test_prescriptions:
                if frappe.db.exists("Prescription", presc_name):
                    frappe.delete_doc("Prescription", presc_name, ignore_permissions=True, force=1)
...
class TestFarmaceuticoRole(TestEpic8Story82RoleAuthorization):
    ...
    def test_farmaceutico_can_read_prescription(self):
        ...
        frappe.clear_cache()
        self.assertTrue(test_can_access_doctype("Prescription", should_access=True))

    def test_farmaceutico_can_write_prescription(self):
        """Farmacéutico puede escribir Prescription"""
        frappe.set_user(self.username)
        frappe.clear_cache()
        self.assertTrue(test_has_permission("Prescription", "write", should_have=True))

    def test_farmaceutico_can_create_prescription(self):
        """Farmacéutico puede crear Prescription"""
        frappe.set_user(self.username)
        frappe.clear_cache()
        self.assertTrue(test_has_permission("Prescription", "create", should_have=True))
...
class TestAuxiliarRole(TestEpic8Story82RoleAuthorization):
    ...
    def test_auxiliar_cannot_write_prescription(self):
        ...
        frappe.set_user(self.username)
        self.assertTrue(test_has_permission("Prescription", "write", should_have=False))
...
class TestBodegueroRole(TestEpic8Story82RoleAuthorization):
    ...
    def test_bodeguero_cannot_access_prescription(self):
        ...
        frappe.set_user(self.username)
        self.assertTrue(test_can_access_doctype("Prescription", should_access=False))
...
class TestAdministrativoRole(TestEpic8Story82RoleAuthorization):
    ...
    def test_administrativo_cannot_write_any_doctype(self):
        ...
        frappe.set_user(self.username)
        critical_doctypes = [
            "Prescription", "Sales Invoice", "Purchase Receipt", 
...
class TestUserPermissions(TestEpic8Story82RoleAuthorization):
    ...
    def test_user_permission_restricts_access_to_specific_documents(self):
        ...
        self.assertTrue(frappe.has_permission("Prescription", "read", presc1))
    ...
    def test_user_permission_works_with_role_permissions(self):
        ...
        self.assertTrue(frappe.has_permission("Prescription", "read", presc))
        self.assertTrue(frappe.has_permission("Prescription", "write", presc))
...
class TestDocumentLevelPermissions(TestEpic8Story82RoleAuthorization):
    ...
    def test_has_permission_with_document(self):
        ...
        self.assertTrue(frappe.has_permission("Prescription", "read", presc))
        self.assertTrue(frappe.has_permission("Prescription", "write", presc))
        self.assertTrue(frappe.has_permission("Prescription", "create"))
        
        # Limpiar
        frappe.set_user("Administrator")
        if frappe.db.exists("Prescription", presc.name):
            frappe.delete_doc("Prescription", presc.name, ignore_permissions=True, force=1)
        frappe.db.commit()
