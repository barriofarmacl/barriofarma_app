...
class TestPurchaseReceiptValidations(unittest.TestCase):
    """Tests unitarios para validaciones DDD de Purchase Receipt"""
    ...
    @unittest.skip("custom_is_excess no existe como Custom Field en Purchase Receipt Item (pendiente de configuración)")
    def test_excess_item_marked_with_is_excess_flag(self):
        """
        Validación: Sobrante no autorizado se marca con custom_is_excess=1
        NOTA: Test deshabilitado hasta que se agregue custom_is_excess como Custom Field
        """
        item = create_test_item(
    ...
    @unittest.skip("custom_qc_status no existe como Custom Field en Purchase Receipt Item (pendiente de configuración)")
    ...
    def test_invoice_excludes_quarantine_items(self):
        ...
        NOTA: Test deshabilitado hasta que se agregue custom_qc_status como Custom Field
        """
        item = create_test_item(
