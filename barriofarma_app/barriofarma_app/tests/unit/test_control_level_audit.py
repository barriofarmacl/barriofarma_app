...
class TestLogControlLevelChange(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from barriofarma_app.barriofarma_app.utils.control_level_audit import log_control_level_change
        self.log_func = log_control_level_change
    
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.get_doc')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.db.exists')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.db.commit')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.session')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.now')
    ...
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.throw')
    ...
    def test_log_item_no_existe_lanza_error(self, mock_throw):
        ...
        with patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.db.exists', return_value=False):
            with self.assertRaises(frappe.ValidationError):
                self.log_func(
...
class TestValidateControlLevelChangeReason(unittest.TestCase):
    ...
    def setUp(self):
        """Configurar mocks antes de cada test"""
        from barriofarma_app.barriofarma_app.utils.control_level_audit import validate_control_level_change_reason
...
class TestDetectAndLogControlLevelChanges(unittest.TestCase):
    ...
    def setUp(self):
        """Configurar mocks antes de cada test"""
        from barriofarma_app.barriofarma_app.utils.control_level_audit import detect_and_log_control_level_changes
        self.detect_func = detect_and_log_control_level_changes
    
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.log_control_level_change')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.get_doc')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.db.exists')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.db.commit')
    @patch('barriofarma_app.barriofarma_app.utils.control_level_audit.frappe.msgprint')
